...
import {
  useCreateHotelPackagesMutation,
  useGetAllHotelPackagesQuery,
...
export default function AddHotelTourPackageForm() {
  ...
  const [createHotelPackages, { data, error }] =
    useCreateHotelPackagesMutation();
  ...
  const { data: singleHotel } = useGetSingleHotelPackagesQuery(
    "68359870981abc53052aa9cf"
  );
