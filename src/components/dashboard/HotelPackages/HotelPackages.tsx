                  ...
                  <div className="flex flex-col h-full">
                    <div>
                      ...
                      <p className="text-gray-600 mb-6">
                        ...
                        greenery, and luxurious accommodations await. Perfect
                        for those looking to unwind and experience the ultimate
                        relaxation.
                      </p>
                    </div>
                    ...
                    <div className="flex gap-3 md:col-span-2   ">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#757D83]">
                          Partnering with the local community to preserving
                          marine life and supporting local communities
                        </p>
                      </div>
                    </div>
