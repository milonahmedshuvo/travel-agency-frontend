...
export default function TourPackageForm() {
  ...
  // Highlights  state
  const [highlights, setHighlights] = useState<THighlights[]>([
      { title: ""}
    ])
  // Description  state 
  ...
  // Included 
  const [includeds, setIncludeds] = useState<THighlights[]>([
      { title: "" }
    ]) 
  // Excluded
   const [excludeds, setExcludeds] = useState<THighlights[]>([
      { title: "" }
    ])   
    // Bring state 
     const [bring, setBring] = useState<THighlights[]>([
      { title: "" }
    ]) 
    // knowBeforeYouGoes
    const [knowBeforeYouGoes, setknowBeforeYouGoes] = useState<TourLovingReasons[]>([
      { title: "", description: "" }
    ])
    // vehicle service
...
const handleChangeItinerary = (index: number, field: keyof TourLovingReasons, value: string) => {
  ...
  const addFeatureItinerary = () => {
    setDetailedItinerarys([...detailedItinerarys, { title: "", description: "" }])
  }
...
const handleGroupSizeChange = (value: string) => {
  ...
  // Highlights 
const handleChangeHighlights = (index: number, field: keyof THighlights, value: string) => {
...
const handleChangeDescription = (index: number, field: keyof TourLovingReasons, value: string) => {
...
// Included function 
const handleChangeIncluded = (index: number, field: keyof THighlights, value: string) => {
...
// Excluded function 
const handleChangeExcluded = (index: number, field: keyof THighlights, value: string) => {
  ...
  // what is Brring 
  const handleChangeBring  = (index: number, field: keyof THighlights, value: string) => {
    const updated = [...bring]
    updated[index][field] = value
    setBring(updated)
  }
  ...
  const handleChangeKnowBeforeYouGoes = (index: number, field: keyof TourLovingReasons, value: string) => {
  ...
  const addFeatureKnowBeforeYouGoes = () => {
    setknowBeforeYouGoes([...knowBeforeYouGoes, { title: "", description: "" }])
  }
...
const handleChangeVehicles = (index: number, field: keyof TourVehicle, value: string) => {
  ...
  const addVehicle = () => {
    setTourPackageVehicles([...tourPackageVehicles, { vehicleType: "", vehicleId: "" }])
  }
...
// image delete 
 const handleDelete = (index: number) => {
  ...
  return (
    <form onSubmit={handleSubmit} className=" px-4 md:px-7 space-y-8 mt-10 mb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <select value={formData.category} onChange={(e) => handleSelectChange("category", e.target.value)}  className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none ">
      ...
      <div className="space-y-5">
        <h1 className="text-[32px] text-[#101010] ">Why Youll Love This Tour</h1>
     ...
     {/* Detailed intinarys section  */}
      <div className="space-y-5">
        <h1 className="text-[32px] text-[#101010] ">Detailed Itinerary – What to Expect</h1>
      ...
      <div className="space-y-5">
...

         {
          ...
          <div  className="space-y-3 ">
            <div className="space-y-2">
              ...
              <input
                value={feature.title}
                onChange={(e) => handleChangeHighlights(index, "title", e.target.value)}
                placeholder="Enter feature title"
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none "
        ...
        <button type="button"  onClick={addFeatureHighlights} className="flex items-center gap-2">
          <PlusCircle className="h-4 w-4" />
          Add Highlight
        </button>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div  key={index} className="relative">
         {
          ...
          <div  className="space-y-3 ">
            <div className="space-y-2">
              ...
              <input
                value={feature.title}
                onChange={(e) => handleChangeDescription(index, "title", e.target.value)}
                placeholder="Enter feature title"
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none "
            ...
            <div className="space-y-2">
              ...
              <textarea 
                value={feature.description}
                onChange={(e) => handleChangeDescription(index, "description", e.target.value)}
                placeholder="Meet your guide at the designated meeting point. Relax in a luxury van as you drive through breathtaking Tuscan landscapes."
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none "
              />
            </div>
        ...
        <button type="button"  onClick={addFeatureDescription} className="flex items-center gap-2">
          <PlusCircle className="h-4 w-4" />
          Add Description
        </button>
      </div>
      ...
      <div className="space-y-5">
        <h1 className="text-[32px] text-[#101010] ">What’s Included & Excluded?</h1>
...

         {
          ...
          <div  className="space-y-3 ">
            <div className="space-y-2">
              ...
              <input
                value={feature.title}
                onChange={(e) => handleChangeIncluded(index, "title", e.target.value)}
                placeholder="Enter feature title"
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none "
        ...
        <button type="button"  onClick={addFeatureIncluded} className="flex items-center gap-2">
          <PlusCircle className="h-4 w-4" />
          Add Included
        </button>
      </div>
      ...
      <div className="space-y-5">
...

         {
          ...
          <div  className="space-y-3 ">
            <div className="space-y-2">
              ...
              <input
                value={feature.title}
                onChange={(e) => handleChangeExcluded(index, "title", e.target.value)}
                placeholder="Enter feature title"
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none "
        ...
        <button type="button"  onClick={addFeatureExcluded} className="flex items-center gap-2">
          <PlusCircle className="h-4 w-4" />
          Add Excluded
        </button>
      </div>
      ...
      <div className="space-y-4">
        <h3 className="text-[32px] text-[#101010] font-medium">Important Information:</h3>

        <div className="space-y-2">
              <label className="block text-sm font-medium">Meeting point (Google maps)</label>
            <input  
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium">Age Requirement</label>
            <input
            id="ageRequirement"
             name="ageRequirement"
      ...
      <div className="space-y-5">
        ...
        <div  key={index} className="relative">
         {
          ...
          <div  className="space-y-3 ">
            <div className="space-y-2">
              ...
              <input
                value={feature.title}
                onChange={(e) => handleChangeBring(index, "title", e.target.value)}
                placeholder="Enter feature title"
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none "
        ...
        <button type="button"  onClick={addFeatureBring} className="flex items-center gap-2">
          <PlusCircle className="h-4 w-4" />
          Add Bring
        </button>
      </div>
     ...
     <div className="space-y-5">
...

         {
          ...
          <div  className="space-y-3 ">
            <div className="space-y-2">
              ...
              <input
                value={feature.title}
                onChange={(e) => handleChangeKnowBeforeYouGoes(index, "title", e.target.value)}
                placeholder="Enter feature title"
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none "
            ...
            <div className="space-y-2">
              ...
              <textarea
                value={feature.description}
                onChange={(e) => handleChangeKnowBeforeYouGoes(index, "description", e.target.value)}
                placeholder="Meet your guide at the designated meeting point. Relax in a luxury van as you drive through breathtaking Tuscan landscapes."
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none "
              />
            </div>
        ...
        <button type="button"  onClick={addFeatureKnowBeforeYouGoes} className="flex items-center gap-2">
          <PlusCircle className="h-4 w-4" />
          Add Feature
        </button>
      </div>
    ...
    <div>
      <h1 className="text-[#101010] text-[18px] " >Do you provide vehicle service?</h1>
      ...
      formData.isVehicleService && <div>
        ...
        <div key={index} className="relative">
          ...
          <div className="space-y-3 grid grid-cols-2 gap-6">
            <div>
              <label className="text-[#101010] text-[18px] !mb-4.5">Vehicle Type</label>
              <select
                value={item.vehicleType}
                onChange={(e) => handleChangeVehicles(index, "vehicleType", e.target.value)}
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none"
              >
                  {
                data?.data?.data.map((vehicle:TVehicleOfObject) => <option key={vehicle.id} value={vehicle.vehicleType}>{vehicle.vehicleType}</option> )
              }
              </select>
            </div>

            <div className="space-y-2">
              <label className="text-[#101010] text-[18px]">Vehicle Name</label>
              <select
                value={item.vehicleId}
                onChange={(e) => handleChangeVehicles(index, "vehicleId", e.target.value)}
                className="py-2.5 px-2 border border-[#98A2B3] w-full rounded focus:outline-none"
              >  

              {
                data?.data?.data.map((vehicle:TVehicleOfObject) => <option key={vehicle.id} value={vehicle.id}>{vehicle.name}</option> )
              }
              </select>
            </div>
        ...
        <button type="button" onClick={addVehicle} className="flex items-center gap-2 mt-1.5">
          <PlusCircle className="h-4 w-4" />
          Add Vehicle
        </button>
