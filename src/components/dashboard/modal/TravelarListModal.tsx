...
//             Create Modal not show data handle delete and cencel
//           </h3>

//           <div className="flex justify-between gap-4 ">
//             <button className="text-black bg-gray-200 py-2 w-full rounded cursor-pointer">
//               cencel
//             </button>
//             <button className="text-white bg-red-500 py-2 w-full rounded cursor-pointer">
//               cencel
//             </button>
//           </div>
