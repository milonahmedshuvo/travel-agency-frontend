...
const formSchema = z
  .object({
    ...
    contactNo: z
      .string()
      .min(2, { message: "contactNo name must be at least 2 characters" }),
    ...
    <div className="w-full max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-6 sm:p-8 mb-20 mt-10">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="space-y-2 ">
            ...
            <input
              ...
              {...register("firstName")}
              className={`border border-[#98A2B3] py-2 px-3 w-full rounded focus:outline-none ${
        ...
        <div className="space-y-2">
          ...
          />
          {errors.contactNo && (
            <p className="text-red-500 text-xs">{errors.contactNo.message}</p>
          )}
        </div>
