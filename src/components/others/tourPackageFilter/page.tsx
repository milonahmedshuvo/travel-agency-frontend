...
import { addTourPackages, removeTourpackages } from "@/redux/slice/searchFilter/searchFilter"
...
//    1971-02-21
   ...
   if(date){
    ...
    try {
      const res = await fetch(`https://supermariobos-api.code-commando.com/api/v1/tour-packages?${queryParams.toString()}&page=1`);
      ...
      <div className="bg-white rounded p-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
          ...
          <div className="space-y-2">
            <label className="text-lg  font-medium text-[#333]">Choose Your Destination</label>
