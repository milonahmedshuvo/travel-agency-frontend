...
import room from "../../../assets/logo/room.png"
...
export default function AccommodationLove ({frist, secound, thrid }: ITravelLoveProps)  {
     ...
     <div className="custom-container mx-auto px-4"> 
      <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-16">
        ...
        <div className="w-full md:w-1/2 relative  mt-8 md:mt-0 !py-20 ">
            {/* <ThreeImage/> */}
            <Image src={room} width={500} height={500} alt="static" className="w-full" />
        </div>
