      ...
      <div className="relative z-10 flex items-center justify-center h-full  text-center ">
        <div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-3.5 md:gap-5 mt-6">
            <button className="text-[#156CF0] text-[16px] bg-[#FFFFFF]  px-[36px] py-[12px] rounded-sm transition duration-300 font-semibold cursor-pointer"> View All Cultural Tours </button>
