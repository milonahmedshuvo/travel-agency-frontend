...
import { Cardp, CardContentp, CardDescriptionp, CardHeaderp, CardTitlep } from "@/components/ui/card"
    ...
    <div className="min-h-screen  p-4 md:p-6">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-semibold mb-1">Customer Profile</h1>
            <p className="text-gray-600 text-[16px]">Manage your travel preferences and information</p>
          </div>

           <Link href='/customer/profileUpdate'> 
          <button  className="flex items-center gap-2 bg-gradient-to-t from-20% from-[#156CF0] to-[#38B6FF] hover:from-[#4f88df] hover:to-[#0096FF] text-white py-1.5 px-3 rounded-lg cursor-pointer">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 ">
            <Cardp>
              <CardHeaderp className="text-center">
                ...
                <CardTitlep className="text-xl">{data?.data?.username}</CardTitlep>
                <CardDescriptionp>
              ...
              <CardContentp className="space-y-4">
