  ...
  return (
    <div className="custom-container">
      ...
      <div className="flex flex-wrap gap-3.5 lg:gap-4 mt-6">
        <button onClick={() => setActiveTab('Sea Tours')} className={`${activeTab == 'Sea Tours'? ' rounded-lg focus:outline-none px-6.5 py-2.5 cursor-pointer  bg-gradient-to-t from-20% from-[#156CF0] to-[#38B6FF] text-white ' : "border border-[#333333] rounded-lg focus:outline-none px-6.5 py-2.5 cursor-pointer  focus:bg-gradient-to-t from-20% from-[#156CF0] to-[#38B6FF] focus:text-white focus:border-0"  }`}>
          Sea Tours
        </button>

        <button  onClick={() => setActiveTab('Land Tours')} className="border border-[#333333] rounded-lg focus:outline-none px-6.5 py-2.5 cursor-pointer  focus:bg-gradient-to-t from-20% from-[#156CF0] to-[#38B6FF] focus:text-white focus:border-0">
          Land Tours
        </button>

        <button onClick={() => setActiveTab('Cultural Tours')} className="border border-[#333333] rounded-lg focus:outline-none px-6.5 py-2.5 cursor-pointer  focus:bg-gradient-to-t from-20% from-[#156CF0] to-[#38B6FF] focus:text-white focus:border-0">
          Cultural Tours
        </button>
        <button onClick={()=> setActiveTab('Gastro & Wine Tours')} className="border border-[#333333] rounded-lg focus:outline-none px-6.5 py-2.5 cursor-pointer  focus:bg-gradient-to-t from-20% from-[#156CF0] to-[#38B6FF] focus:text-white focus:border-0">
          Gastro & Wine Tours
        </button>
