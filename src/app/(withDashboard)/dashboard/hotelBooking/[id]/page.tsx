...
import HotelCencelModal from "@/components/dashboard/modal/HotelCencelModal";
...
const MyHotelBookingDatailsPage = () => {
  ...
  const handleHotelBookingCencel = () => {
    console.log("click");
    setShowModal(true)
  };
  ...
  return (
    <div className="pb-20 !bg-white">
      ...
      <div className="flex justify-end mt-10 mr-6">
        <button
          onClick={handleHotelBookingCencel}
          className="text-black bg-gray-200 py-4  rounded-xl cursor-pointer w-[130px] text-xl hover:text-red-500 opacity-85 "
        >
          cencel
        </button>
      </div>
      ...
      {
         showModal && <HotelCencelModal closeModal={closeModal} />
      }
    </div>
  );
};
